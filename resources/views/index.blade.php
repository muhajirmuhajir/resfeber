...
================================================== -->
    <section id="features" class="dtr-section dtr-box-layout dtr-py-100">
        ...
        <div class="row">
            ...
            <!-- column 1 starts -->
            <div class="col-12 col-md-4 dtr-feature dtr-feature-top">
                <div class="dtr-feature-img"><img src="assets/images/features-img1.png" alt="image"></div>
                <h4>Home Appraisal</h4>
                <p>Lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod tempor incididunt ut
                    labore et dolore magna aliquais ipsum ultrices.</p>
            </div>
            <!-- column 1 ends -->

            <!-- column 2 starts -->
            <div class="col-12 col-md-4 dtr-feature dtr-feature-top">
                <div class="dtr-feature-img"><img src="assets/images/features-img2.png" alt="image"></div>
            ...
            <!-- column 3 starts -->
            <div class="col-12 col-md-4 dtr-feature dtr-feature-top">
                <div class="dtr-feature-img"><img src="assets/images/features-img3.png" alt="image"></div>
    ...
    <section id="cta" class="dtr-section dtr-box-layout">
        ...
        <div class="dtr-box-wrapper-round dtr-bg-shapes-type-2 dtr-box-padding bg-white">
            ...
            <div class="row">
                ...
                <!-- column 1 starts -->
                <div class="col-12 col-md-4 dtr-cta-box">
                    <!-- img -->
                    ...
                    <div class="dtr-cta-content">
                        ...
                        <div class="dtr-cta-content-right"> <a href="#" class="dtr-btn btn-blue"><i
                ...
                <!-- column 2 starts -->
                <div class="col-12 col-md-4 dtr-cta-box offset-md-2 small-device-space">
                    <!-- img -->
...
================================================== -->
    <section id="about" class="dtr-section dtr-box-layout">
        ...
        <div class="row dtr-mr-0">
            ...
            <div class="col-12 col-md-6 dtr-py-100 dtr-pr-100">
                ...
                <div class="dtr-section-heading-wrapper dtr-mb-20">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipiscing elit, sed do eiusmod tempor incididunt
                        soluta nobis assumenda labore quod maxime.</p>
                </div>
                <!-- heading ends -->

                <!-- text -->
                <p>There are many variations of passages of lorem ipsum available. Nam libero tempore cum soluta
                    nobis est eligendi optio cumque nihil impedit quo minus id quod maxime but the majority have
                    suffered alteration in some form by injected humour or randomised words which don't look
                    even slightly believable. </p>

                <!-- photo chain starts -->
                <div class="d-flex align-items-center dtr-mt-30">
                    <div class="dtr-photo-chain"><span><img src="assets/images/user-1.jpg"
                                alt="image"></span><span><img src="assets/images/user-2.jpg"
                                alt="image"></span><span><img src="assets/images/user-3.jpg"
                                alt="image"></span><span><img src="assets/images/user-4.jpg"
                                alt="image"></span><span class="bg-blue color-white">1M+</span></div>
            ...
            <!-- column 2 starts -->
            <div class="col-12 col-md-6 dtr-box-full-img dtr-mt-minus50 dtr-rounded-left-bottom"
                style="background-image: url(assets/images/img-2.jpg);"> </div>
            <!-- column 2 ends -->
            ...
            <div class="row d-flex align-items-center dtr-mt-70">
                ...
                <div class="col-12 col-md-6">
                    <div class="dtr-label-wrapper">
                        ...
                        <!-- image -->
                        <img src="assets/images/img-3.jpg" alt="image" class="dtr-rounded-img"></div>
                </div>
                <!-- column 1 ends -->
                ...
                <div class="col-12 col-md-6">
                    <div class=" dtr-pl-40 dtr-sm-pl-0 small-device-space">
                        <p class="text-size-sm dtr-mb-10"><i class="icon-map-pin1 dtr-mr-10"></i>30 Beverly
                            Hills, Los Angeles</p>
                        ...
                        <p class="dtr-mb-30">There are many variations of passages of lorem ipsum available, but
                            the majority have suffered alteration in some form by injected humour or randomised
                            words which don't look even slightly believable. </p>

                        <!-- button -->
                        <a class="dtr-btn dtr-video-popup dtr-btn-right-icon dtr-mr-5 btn-dark-blue"
                            data-autoplay="true" data-vbtype="video"
                            href="https://www.youtube.com/watch?v=kuceVNBTJio">Take a Tour<span
                                class="btn-span bg-blue color-white"><i class="icon-play1"></i></span></a>
                        <!-- button ends -->

                        <!--== share starts ==-->
                        <div class="dtr-share">
                            <div class="dtr-btn dtr-btn-only-icon btn-blue"><i class="icon-share-2"></i></div>
                            <ul class="dtr-share-dropdown dtr-social dtr-share-list">

                                <!-- twitter -->
                                <li><a href="https://twitter.com/share?text=Title%20Goes%20Here&amp;url=http://yourlink.com"
                                        ...
                                        class="dtr-twitter" title="twitter"></a></li>

                                <!-- facebook -->
                                <li> <a href="https://www.facebook.com/sharer/sharer.php?u=http://yourlink.com"
                                        onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=500,width=500');return false;"
                                        class="dtr-facebook" title="facebook"> </a> </li>

                                <!-- linkedin -->
                                <li> <a href="https://www.linkedin.com/shareArticle?mini=true&amp;url=http://yourlink.com&amp;title=Title%20Goes%20Here&amp;summary=Summary%20Goes%20Here&amp;source=#"
                                        onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=500,width=500');return false;"
                                        class="dtr-linkedin" title="instagram"> </a> </li>
                            </ul>
                        </div>
                        <!--== share ends ==-->
            ...
            <div class="row d-flex align-items-center dtr-mt-100">
                ...
                <div class="col-12 col-md-6">
                    <div class=" dtr-pr-40 dtr-sm-pl-0 small-device-space">
                        <p class="text-size-sm dtr-mb-10"><i class="icon-map-pin1 dtr-mr-10"></i>995 Fifth
                            Avenue, New York</p>
            ...
            <div class="row d-flex align-items-center dtr-mt-100">
                ...
                <div class="col-12 col-md-6">
                    <div class="dtr-label-wrapper">
                        ...
                        <span class="dtr-label dtr-label-green">For Sale</span>
                        <!-- image -->
                        <img src="assets/images/img-5.jpg" alt="image" class="dtr-rounded-img"></div>
                </div>
                <!-- column 1 ends -->
                ...
                <div class="col-12 col-md-6">
                    <div class=" dtr-pl-40 dtr-sm-pl-0 small-device-space">
                        <p class="text-size-sm dtr-mb-10"><i class="icon-map-pin1 dtr-mr-10"></i>Stratford Road,
                            UK</p>
                        <h2 class="dtr-mb-10">Family House</h2>
                        <p class="tagline-style1 color-green text-shadow-green">$7,261,300</p>
...
================================================== -->
    <section id="reviews" class="dtr-section dtr-box-layout">
        ...
        <div class="row dtr-mr-0">
            ...
            <div class="col-12 col-md-5 dtr-py-100">
                ...
                <div class="dtr-slick-slider dtr-testimonial-slider dtr-slick-has-dots">
                    ...
                    <div class="dtr-testimonial">
                        ...
                        <div class="dtr-testimonial-content clearfix"> There are many variations of passages of
                        ...
                        <div class="dtr-client-info clearfix">
                            <div class="dtr-testimonial-user"><img src="assets/images/user-1.jpg" alt="image">
                            </div>
                            <div class="dtr-testimonial-user-info">
                                <h6 class="dtr-client-name">Eleanor Jensen</h6>
                                <span class="dtr-client-job">Villa Owner, LA</span>
                            </div>
                        </div>
                        <!-- client info ends -->
                    </div>
                    ...
                    <div class="dtr-testimonial">
                        ...
                        <div class="dtr-testimonial-content clearfix"> Lorem ipsum dolor sit amet consectetur
                            adipiscing elit sed do eiusmod tempor incididunt aute irure dolor in reprehenderit
                            in voluptate velit esse cillum dolore beatae vitae dicta sunt explicabo magna
                            aliqua. </div>
                        <!-- client info -->
                        <div class="dtr-client-info clearfix">
                            <div class="dtr-testimonial-user"><img src="assets/images/user-2.jpg" alt="image">
                            </div>
                            <div class="dtr-testimonial-user-info">
                                <h6 class="dtr-client-name">Jerry Johnston</h6>
                                <span class="dtr-client-job">Acme Boutique, UK</span>
                            </div>
                        </div>
                        <!-- client info ends -->
                    </div>
                    ...
                    <div class="dtr-testimonial">
                        ...
                        <div class="dtr-testimonial-content clearfix"> Nemo enim ipsam voluptatem quia voluptas
                            sit aspernatur odit aut fugit sed quia consequuntur magni dolores eos qui ratione
                            voluptatem sequi nesciunt porro quisquam qui dolorem ipsum quia dolor sit
                            consectetur. </div>
                        <!-- client info -->
                        <div class="dtr-client-info clearfix">
                            <div class="dtr-testimonial-user"><img src="assets/images/user-3.jpg" alt="image">
                            </div>
                            <div class="dtr-testimonial-user-info">
                                <h6 class="dtr-client-name">Kamila Anderson</h6>
                                <span class="dtr-client-job">House Buyer, Colorado</span>
                            </div>
                        </div>
                        <!-- client info ends -->
                    </div>
            ...
            <!-- column 2 starts -->
            <div class="col-12 col-md-6 offset-md-1 dtr-box-full-img dtr-mt-minus50 dtr-rounded-left-bottom"
                style="background-image: url(assets/images/img-6.jpg);"> </div>
            <!-- column 2 ends -->
...
================================================== -->
    ...
    <section id="contact"
        class="dtr-section dtr-box-layout dtr-box-wrapper-round dtr-bg-shapes-type-5 dtr-box-padding bg-white">
        ...
        <div class="row dtr-bg-shapes-type-4">
            ...
            <div class="col-12 col-md-8 offset-md-2 text-center">
                    ...
                    <form id="contactform" method="post" action="php/contact-form.php">
                        <fieldset>
                            ...
                            <p class="text-center dtr-mb-0">
                                <button class="dtr-btn dtr-btn-right-icon btn-dark-blue" type="submit">Send
                                    Message <span class="btn-span bg-blue color-white"><i
                ...
                <div class="spacer-100"></div>
                <p>007, Bond Street, Mighty Meadows, Australia<br>
                    1 800 234 56 78</p>
                <p class="tagline-style1 color-green text-shadow-green">sales@examplereales.com</p>
            </div>
            <!-- column ends -->
